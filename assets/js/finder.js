...
function getAllData() {
  ...
  ${USER.repos.map((repo) => `<div class='repo'><h3 class='repo-name'>${repo.name}</h3><p class='repo-description'>${repo.description == null ? (repo.description = "No description") : repo.description}</p>
